  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await emailjs.send(
        'service_miqfb9m', // Your service ID
        'template_4t4qc8o', // Your template ID
        {
          name: formData.name,
          ...
          <div className="flex sm:px-6 lg:px-10 px-4 flex-col sm:flex-row sm:justify-between gap-6 sm:gap-12">
            ...
            <div className='flex flex-col sm:flex-row gap-6 sm:gap-8 lg:gap-12'>
              ...
              <div>
                ...
                <a href="mailto:info@moonshotstudio.ai" className="text-gray-400 text-xs sm:text-sm block mb-4">
